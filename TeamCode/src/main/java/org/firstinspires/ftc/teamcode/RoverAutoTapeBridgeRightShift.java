...
@Autonomous(name="Rover Auto Tape Bridge Right Shift")

public class RoverAutoTapeBridgeRightShift extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        //while (opModeIsActive()) {
            ...
            rover.ClearEncoders();
            rover.SetEncoderDistance(direction.SHIFT_R, 4000);
